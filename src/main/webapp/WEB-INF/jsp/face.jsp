...
<body>
	<div class="container-fluid" style="text-align: center;">
		...
		<div class="row">
			 <button type="button" class="btn btn-primary" onclick="faceImage()">注册人脸(百度云)</button>			 
		</div>
		<div class="row">
...
function faceImage(){
	...
	$.ajax({
		 type: "POST",
		 async:true,
		 url: '<%=request.getContextPath()%>/faceRegist',
...
function searchface(){
	window.location.href='<%=request.getContextPath()%>/inintsearchFace';
}
</script>